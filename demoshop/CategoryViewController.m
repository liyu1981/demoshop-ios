...
- (void)viewDidLoad {
    ...
    self.objects = [app getCategories];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"categorySelected"]) {
        ...
        ProductListViewController *controller = (ProductListViewController *)[[segue destinationViewController] topViewController];
